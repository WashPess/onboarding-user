...
public class RegexCompile {
	...
	public static final Pattern OnlyNumberForDocument = Pattern.compile("^[0-9-./X]+$", Pattern.CASE_INSENSITIVE);
	public static final Pattern OnlyNumberForPhone = Pattern.compile("^[0-9-+() ]+$", Pattern.CASE_INSENSITIVE);
	public static final Pattern OnlyLetter = Pattern.compile("^[a-zA-Z ]+$", Pattern.CASE_INSENSITIVE);
	public static final Pattern HasNumber = Pattern.compile(".*[0-9].*", Pattern.UNICODE_CASE);
